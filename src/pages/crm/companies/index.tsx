    ...
    <DashboardLayout>
      ...
      >
        <motion.div
          ...
          className="max-w-[1600px] mx-auto w-full flex flex-col min-h-0 flex-1"
        >
          ...
          {/* Companies List */}
          <div className="flex flex-col lg:flex-row items-start gap-2 sm:gap-3 md:gap-4 lg:gap-6 flex-1 min-h-0">
            {/* Left: Companies List */}
            <div
