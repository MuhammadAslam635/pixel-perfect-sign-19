        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 p-2 bg-[#2A3435]/50 rounded-lg border border-white/5">
            ...
            <Button
              ...
              disabled={loading}
              className="relative text-white border-0 rounded-full px-4 h-7 flex items-center justify-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto hover:bg-[#2F2F2F]/60 transition-all overflow-hidden"
              style={{
                background: "#FFFFFF1A",
                boxShadow:
