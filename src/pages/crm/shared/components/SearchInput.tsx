...
export const SearchInput = ({
  ...
  return (
    <div
      className={`relative w-full sm:w-auto sm:min-w-[220px] sm:max-w-[280px] ${className}`}
    >
      ...
      <Input
        ...
        className="h-9 pl-10 pr-10 rounded-lg sm:!rounded-full border border-gray-600 sm:border-0 text-white placeholder:text-gray-500 text-xs w-full bg-gray-800/50 sm:bg-[#FFFFFF1A]"
        style={{
          boxShadow: "none",
        }}
      />
      ...
      {/* Filter Icon - Mobile Only (when no search value) */}
      {!value && (
