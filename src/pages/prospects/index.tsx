            ...
            >
              ...
              >
                <Tabs
                  ...
                  className="w-full"
                >
                  <TabsList className="flex flex-row overflow-x-auto items-center gap-2 bg-transparent border border-[#FFFFFF0D] p-2 rounded-xl w-full justify-start mb-6">
                    <motion.div
                    ...
                    >
                      <TabsTrigger
                        value="sessions"
                        className="flex justify-center whitespace-nowrap gap-2 py-3 px-6 rounded-lg text-gray-300 font-medium
