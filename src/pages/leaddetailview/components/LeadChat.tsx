  ...
  return (
    ...
    >
          ...
          <div className="flex w-full flex-wrap items-center gap-2 sm:gap-4 lg:w-[55%]">
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  <span
                    className={`text-sm font-medium sm:text-base lg:text-[16px] ${
      ...
      <div className="flex w-full flex-col gap-6 py-8 sm:flex-row items-center sm:justify-between">
        <div className="flex items-center gap-4 text-left flex-wrap sm:flex-nowrap">
          ...
          <div className="flex flex-col px-0 sm:px-5 sm:pt-0">
            <p className="text-lg font-bold sm:text-xl lg:text-[20px]">
              Saad Naeem
            </p>
            <p className="text-xs font-normal text-white/60 sm:text-sm lg:text-[14px]">
      ...
      <div className="flex flex-col w-full">
        {activeTab === "WhatsApp" ? (
          <>
            <div className="flex flex-1 flex-col overflow-y-auto lg:max-h-[calc(100vh-510px)] max-h-[calc(100vh-350px)] scrollbar-hide">
                ...
                {mockMessages.map((message) => (
                  ...
                  >
                    ...
                    <div className="flex max-w-[90%] flex-col sm:max-w-[80%]">
                      <p
                        className={`text-xs font-normal leading-6 p-5 sm:text-sm sm:leading-7 sm:p-6 lg:text-[13px] lg:leading-[30px] lg:p-8 ${
                          message.from === "user"
