...
import { EmailComposer } from "@/pages/company/crm/emails/components/EmailComposer";
...
const ComposePage = () => {
  ...
  const sendMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: "Failed to send email", description: error.response?.data?.message || "An error occurred while sending the email.", variant: "destructive",
      });
    },
  });
