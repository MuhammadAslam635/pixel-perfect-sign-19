                  ...
                  >
                    <TabsList className="flex items-center gap-1 bg-transparent border-0 p-0">
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} transition={{ duration: 0.2 }}>
                        <TabsTrigger value="sessions" className="flex justify-center whitespace-nowrap gap-1.5 py-2 px-4 rounded-lg text-xs text-gray-300 font-medium data-[state=active]:text-white data-[state=active]:bg-white/10 data-[state=active]:shadow-[0px_3.43px_3.43px_0px_#FFFFFF29_inset,0px_-3.43px_3.43px_0px_#FFFFFF29_inset] transition-all duration-300 hover:bg-white/5">
                          <Activity size={14} />
                          <span>Sessions</span>
                        </TabsTrigger>
                      </motion.div>
                      ...
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} transition={{ duration: 0.2 }}>
                        <TabsTrigger value="queries" className="flex justify-center whitespace-nowrap gap-1.5 py-2 px-4 rounded-lg text-xs text-gray-300 font-medium data-[state=active]:text-white data-[state=active]:bg-white/10 data-[state=active]:shadow-[0px_3.43px_3.43px_0px_#FFFFFF29_inset,0px_-3.43px_3.43px_0px_#FFFFFF29_inset] transition-all duration-300 hover:bg-white/5">
