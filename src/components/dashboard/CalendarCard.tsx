  ...
  return (
    <Card className="solid-card p-3 lg:p-5">
      ...
      <div className="space-y-2 mt-6 gap-6 lg:space-y-3 card-scroll scrollbar-hide">
        <div>
          <span className="calendar-label mb-1.5 lg:mb-2 inline-block text-[9px] !sm:hidden lg:text-xs">
            Today
          </span>
          ...
          <div className="relative">
            ...
            <div className="flex items-start gap-2 lg:gap-3 p-2 lg:p-3 rounded-lg calendar-row transition-smooth">
              <div className="flex-1 min-w-0">
                ...
                <span className="text-[9px] lg:text-xs text-muted-foreground/60 mt-0.5 lg:mt-1 block">
                  2:00 PM
                </span>
              </div>
            </div>
