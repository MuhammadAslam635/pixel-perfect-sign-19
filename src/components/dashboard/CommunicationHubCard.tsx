      ...
      <div className="space-y-1.5 lg:space-y-2">
        <div className="flex items-center gap-2 lg:gap-3 p-2 lg:p-3 teal-row transition-smooth">
          <Avatar className="w-6 h-6 lg:w-8 lg:h-8 flex-shrink-0">
            <AvatarFallback className="text-[10px] lg:text-xs" style={{
              background: 'linear-gradient(180deg, rgba(103,178,183,0.20) 0%, rgba(103,178,183,0.14) 100%)',
              color: '#67B2B7'
            }}>SJ</AvatarFallback>
          </Avatar>
          <div className="flex-1 min-w-0">
            <p className="text-[10px] lg:text-sm font-normal text-foreground truncate leading-tight">Call with Sarah Johnson</p>
            <p className="text-[9px] lg:text-xs text-muted-foreground/60">3m 45s</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 lg:gap-3 p-2 lg:p-3 teal-row transition-smooth">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] lg:text-sm font-normal text-foreground truncate leading-tight">Email from Mark Evans</p>
            <p className="text-[9px] lg:text-xs text-muted-foreground/60">9:12 AM</p>
          </div>
        </div>
      </div>
    </Card>
