                    ...
                    {filteredNavLinks.map((link) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg !transition-none text-white/70 hover:text-white hover:bg-white/10"
                          type="button"
                        >
