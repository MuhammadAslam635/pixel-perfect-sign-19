    ...
    <Card className="solid-card p-3 lg:p-5">
      <div className="flex items-center justify-between mb-2 lg:mb-4">
        <div className="flex items-center gap-1.5 lg:gap-2">
          ...
          <h3 className="font-medium text-[10px] lg:text-sm glass-card-header leading-tight">Top Leads</h3>
        </div>
      ...
      <div className="space-y-1.5 lg:space-y-2 card-scroll scrollbar-hide">
        {leads.map((lead) => (
          <div key={lead.name} className="p-2 pl-2.5 lg:p-3 lg:pl-4 leads-row transition-smooth">
            <div className="flex flex-col">
              <span className="text-[10px] lg:text-sm font-normal text-foreground leading-tight">{lead.name}</span>
              <div className="mt-0.5 lg:mt-1 flex items-center gap-1.5 lg:gap-2">
                ...
                <span className="text-[9px] lg:text-xs text-white/70">Score: {lead.score}%</span>
              </div>
            </div>
          </div>
        ))}
